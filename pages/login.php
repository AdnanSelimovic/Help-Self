    ...
    <main class="container mt-5">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <form action="path/to/your/login_handler.php" method="POST">
                    <div class="mb-3">
                ...
                <div class="mt-3">
                    <p class="text-center">Don't have an account? <a href="/Help-Self/registration">Register here</a>.
                    </p>
                </div>
            </div>
        </div>
